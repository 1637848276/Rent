	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i>
				<a href="javascript:void(0);">编辑饮用水费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li id="dropDownList"><span class="span">水分类：</span>
						...
						<li><span class="span">发生时间：</span><input type="text" class="pack_maintain" disabled="disabled"></li>
						...
						<li><span class="span"></span><a onclick="updateWaterBill(${param.id});" class="btn btn-goback goback">确认更新</a></li>
					</ul>
				</div>
			</div>
		</div>
