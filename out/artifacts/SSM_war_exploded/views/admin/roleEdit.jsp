...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/ld/admin/roleEdit.js"></script>
<link
...
<link href="${pageContext.request.contextPath}/css/ld/admin/public.css"
	rel="stylesheet" type="text/css" />
<link
	href="${pageContext.request.contextPath}/css/ld/admin/roleEdit.css"
	rel="stylesheet" type="text/css" />
<title>角色权限管理</title>
</head>
<body>
	...
	<div class="content">
		...
		<div class="body" style="margin-left:-30px;">
			...
			<div class="body-third">
				<h4>小卖部和爱心驿站</h4>
				<div class="checkbox-group">
					<input type="checkbox" id="checkbox_role9" class="checkbox"/> <label for="checkbox_role9"></label>
				</div>
				<div class="checkbox-text3">查看小卖部</div>

				<div class="checkbox-group">
					<input type="checkbox" id="checkbox_role10" class="checkbox" /> <label for="checkbox_role10"></label>
				</div>
