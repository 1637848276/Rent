	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i>
				<a href="javascript:void(0);">编辑餐费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li><span class="span">金额：</span><input type="text" value="" id="count"/>元</li>
						<li><span class="span"></span>
						    <input type="radio" value="0" name="pay" checked="checked"/>现金
						    <input type="radio" value="1" name="pay"/>月结</li>
						<li><span class="span" >备注：</span><input type="text" value="" id="comment"/></li>
						<li><span class="span">点餐日期：</span><input type="text" value="" id="time" class="pack_maintain" /></li>
						<li id="staffSort"><span class="span">点餐人：</span><input value="0 0" type="text" id="staffInput" />
						    <div class="staffMenu">
								<ul id="staff">
								</ul>
							</div>
						 </li>
						<li><span class="span"></span><a onclick="updateServiceTakeawayEdit(${param.id});" class="btn btn-goback goback">确认变更</a></li>
					</ul>
				</div>
			</div>
		</div>
