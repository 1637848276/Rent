	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i>
				<a href="javascript:void(0);">新增其它车费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li id="dropDownList"><span class="span">用车种类：</span>
							<input type="text" id="dropDownInput" value="租车" />
						...
						<li><span class="span"></span><a onclick="addBusOther();" class="btn btn-goback goback">确认添加</a></li>
					</ul>
				</div>
			</div>
		</div>
