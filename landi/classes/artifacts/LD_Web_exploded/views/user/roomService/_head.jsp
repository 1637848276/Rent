...
<body>
	...
	<div class="roomNav">
		<ul class="roomNavInner">
				...
				<div class="index">
					...
					<div class="plate plate-roomService">
						<div class="plate-title">
							<div class="title-head">
								<img
									src="${pageContext.request.contextPath}/img/roomService/shirt.svg" /><span>&nbsp;&nbsp;&nbsp;客房服务</span>
							</div>
						</div>
						<div class="plate-content">
							<div class="content-title">
								<ul>
									...
									<li><div class="icon"></div>
										<a
										href="${pageContext.request.contextPath}/views/user/roomService/service/serviceShopping.jsp">代购费</a></li>
									<li><div class="icon"></div>
										<a>车费</a></li>
					...
					<div class="plate plate-repair">
						<div class="plate-title">
							<div class="title-head">
								<img
									src="${pageContext.request.contextPath}/img/roomService/tools.svg" /><span>&nbsp;&nbsp;&nbsp;客房维修</span>
							</div>
						</div>
						<div class="plate-content">
							<div class="content-title">
					...
					<div class="plate plate-resource">
						<div class="plate-title">
							<div class="title-head">
								<img
									src="${pageContext.request.contextPath}/img/roomService/drops.svg" /><span>&nbsp;&nbsp;&nbsp;能源费结算</span>
							</div>
						</div>
						<div class="plate-content">
							<div class="content-title">
								<ul>
									<li><div class="icon"></div>
										<a
										href="${pageContext.request.contextPath}/views/user/roomService/source/sourceWater.jsp">水费</a></li>
									<li><div class="icon"></div>
										<a
										href="${pageContext.request.contextPath}/views/user/roomService/source/sourceElec.jsp">电费</a></li>
									<li><div class="icon"></div>
										<a
										href="${pageContext.request.contextPath}/views/user/roomService/source/sourceGas.jsp">燃气费</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="plate plate-other">
						<div class="plate-title">
							<div class="title-head">
								<img
									src="${pageContext.request.contextPath}/img/roomService/calculate.svg" /><span>&nbsp;&nbsp;&nbsp;客房费用结算</span>
							</div>
						</div>
						<div class="plate-content">
							<div class="content-title">
			...
			<li class="nav-li"><a
				href="${pageContext.request.contextPath}/views/user/home/homeUser.jsp">首页</a></li>
			<li class="nav-li"><a
