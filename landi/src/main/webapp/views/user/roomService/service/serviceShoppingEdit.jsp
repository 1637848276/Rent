	...
	<div class="main">
		<div class="main-page">
			<div class="nav-path">
				...
				<i class="icon-path"></i>
				<a id="serviceType" href="serviceShopping.jsp">代购费</a>
				<i class="icon-path"></i>
				<a href="javascript:void(0);">新增代购费记录</a>
			</div>
			<div class="body">
				<div class="body-content">
					<ul>
						...
						<li><span class="span">数量：</span><input type="text" id="count" />件</li>
						...
						<li><span class="span">备注：</span><input type="text" id="comment" value="" /></li>
						<li><span class="span">日期：</span><input type="text" value="" id="time" class="pack_maintain" /></li>
						<li id="staffSort"><span class="span">垫付人：</span><input value="0 请选择" type="text" id="staffInput" />
						    <div class="staffMenu">
								<ul id="staff">
								</ul>
							</div></li>
						<li><span class="span">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span id="pay-staff-waring" class="red red-right" style="display:none;margin-left:120px;" >*&nbsp;垫付人信息失效，请重新选择</span></li>
						<li><span class="span"></span><a onclick="updateServiceShoppingEdit(${param.id});" class="btn btn-goback goback">确认变更</a></li>
					</ul>
				</div>
			</div>
		</div>
