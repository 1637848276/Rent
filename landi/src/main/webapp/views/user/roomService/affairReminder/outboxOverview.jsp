...
<link href="${pageContext.request.contextPath}/css/ld/user/roomService/affairReminder/outboxOverview.css" rel="stylesheet" type="text/css" />
<title>发件箱</title>
</head>
<body>
	...
	<div class="main">
		<div class="main-page">
			...
			<a class="btn btn-new btnnew" href="writeMail.jsp">写信</a>
